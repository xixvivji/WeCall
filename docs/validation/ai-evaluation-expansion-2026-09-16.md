...
최종 [CI 35055226424](https://github.com/xixvivji/WeCall/actions/runs/35055226424), 코드 `e64782d`: Python35건, 백엔드114건, 프론트26건 및 HTTP 업무 검증·빌드 통과. 실제 모델 평가35건은 로컬에서 별도로 수행했으며 CI는 모델을 다운로드하지 않는다.
