...
public class ExtractionClient {
    public record Response(Result result,String raw) {}
    public static class Failed extends RuntimeException {
        public final String code,raw;
        public Failed(String code,String raw) {super(code);this.code=code;this.raw=raw;}
    }
    private final RestClient client;
    private final ObjectMapper json;
    private final String base,token;
    private final boolean allowMock;
    public ExtractionClient(ObjectMapper json,@Value("${wecall.ai.base-url:http://127.0.0.1:8000}") String base,
