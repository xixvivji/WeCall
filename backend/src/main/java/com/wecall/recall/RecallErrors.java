...
@RestControllerAdvice(assignableTypes = {com.wecall.attachment.AttachmentController.class,AssessmentExportController.class, WorkspaceController.class, RecallController.class, EvidenceController.class, TaskController.class, ClosureController.class, ExtractionController.class, com.wecall.auth.AuthController.class})
class RecallErrors {
