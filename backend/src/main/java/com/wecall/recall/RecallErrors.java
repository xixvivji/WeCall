...
@RestControllerAdvice(assignableTypes = {RecallController.class, EvidenceController.class, TaskController.class, ClosureController.class, com.wecall.auth.AuthController.class})
class RecallErrors {
