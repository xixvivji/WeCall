...
public class ClosureService {
    ...
    public ClosureService(JdbcTemplate jdbc,ObjectMapper json,RecallService recalls,CaseGuard guard) {
    ...
    public Map<String,Object> check(UUID caseId,UUID assessmentId) {
        ...
        var latest=jdbc.queryForList("SELECT id,status,version FROM recall_condition WHERE case_id=? ORDER BY version DESC LIMIT 1",caseId);
