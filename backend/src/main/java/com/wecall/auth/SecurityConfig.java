...
public class SecurityConfig {
    ...
    @Bean SecurityFilterChain security(HttpSecurity http,UserDirectory users) throws Exception {
        ...
        http.addFilterAfter(new AccountSessionFilter(users),org.springframework.security.web.context.SecurityContextHolderFilter.class);
